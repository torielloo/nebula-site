...
export default async function(req: Request) {
  ...
  // Optional second factor for automation/service uploads. The value lives only
  // in Base44 Secrets; there is intentionally no hard-coded fallback.
  const expectedSecret = secrets.get('DOWNLOADS_BANNER_UPLOAD_SECRET');
