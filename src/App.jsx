...
const NitroReceiptUpload = lazy(() => import('@/pages/NitroReceiptUpload'));
...
const AuthenticatedApp = () => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/nitro/comprovante/:sessionId/:token" element={<NitroReceiptUpload />} />
      <Route path="/nitro/comprovante/:token" element={<NitroReceiptUpload />} />
