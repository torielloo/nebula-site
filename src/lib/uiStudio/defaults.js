...
export const UI_PRESETS = [
  { id: "cyber-red", name: "Cyber Red", accent: "#ff263b", swatch: "#ff263b", desc: "Preto, vermelho neon e brilho." },
  { id: "minimal-ios", name: "Minimal iOS", accent: "#8fa3bf", swatch: "#8fa3bf", desc: "Vidro, limpo e suave." },
  { id: "gamer", name: "Gamer RGB", accent: "#8b5cf6", swatch: "#8b5cf6", desc: "Tipografia e ícones em RGB dinâmico, suave e contínuo." },
];
