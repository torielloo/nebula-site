const T = {
  ...
  "0XC0000142": {
    en: {
      ...
      solution: "1. Check antivirus Protection History and restore/allow Nébula files.\n2. Install the latest supported Microsoft Visual C++ Redistributable — this is the required version: https://learn.microsoft.com/pt-br/cpp/windows/latest-supported-vc-redist?view=msvc-170#latest-supported-redistributable-version\n3. Install/update DirectX.\n4. Run sfc /scannow in Administrator CMD.\n5. Restart the computer and test again as Administrator."
    },
    es: {
      title: "Error 10 — 0xc0000142",
      ...
      solution: "1. Revisa el Historial de protección del antivirus y restaura/permite los archivos de Nébula.\n2. Instala la versión más reciente compatible de Microsoft Visual C++ Redistributable — esta es la versión necesaria: https://learn.microsoft.com/pt-br/cpp/windows/latest-supported-vc-redist?view=msvc-170#latest-supported-redistributable-version\n3. Instala/actualiza DirectX.\n4. Ejecuta sfc /scannow en CMD como Administrador.\n5. Reinicia el equipo y prueba de nuevo como Administrador."
    }
  },
  ...
  "0xC0000005": {
    en: {
      ...
      meaning: "Error 0xC0000005 indicates an access violation during startup: Fortnite attempted an invalid memory access or was interrupted by an external component.",
      cause: "Conflicts with overlays, recording or background software; antivirus/Windows Defender blocking an official component; insufficient permissions; or outdated/corrupted system libraries.",
      identification: "Fortnite closes during startup and shows 0xC0000005. Check for active overlays, recorders, monitoring tools or macro software and review Windows Security Protection History at the same time.",
      solution: "1. Completely close overlay or capture applications such as RivaTuner Statistics Server (RTSS), MSI Afterburner, Medal.tv, OBS Studio and Overwolf. Also disable Discord and GeForce Experience/ShadowPlay overlays and close mouse/macro software running in the background.\n2. Open Windows Security > Virus & threat protection > Protection history and check for a block at the same time. Only restore or allow a file after confirming it is official and legitimate. Avoid broad antivirus exclusions.\n3. Completely close the Nébula Launcher and open it again with Run as Administrator.\n4. Install/update Microsoft Visual C++ Redistributable (x64) and DirectX End-User Runtime from official Microsoft sources.\n5. Restart the computer and try again. If it continues, send Staff the 0xC0000005 code, the time of the error and a screenshot of Protection History without personal data."
    },
    es: {
      title: "Violación de acceso / 0xC0000005",
      meaning: "El error 0xC0000005 indica una violación de acceso durante el inicio: Fortnite intentó acceder a memoria de forma no válida o fue interrumpido por un componente externo.",
      cause: "Conflictos con overlays, grabadores o software en segundo plano; antivirus/Windows Defender bloqueando un componente oficial; falta de permisos; o bibliotecas del sistema desactualizadas/dañadas.",
      identification: "Fortnite se cierra durante el inicio y muestra 0xC0000005. Comprueba overlays, grabadores, herramientas de monitorización o software de macros activos y revisa el Historial de protección de Seguridad de Windows en el mismo horario.",
      solution: "1. Cierra completamente aplicaciones de overlay o captura como RivaTuner Statistics Server (RTSS), MSI Afterburner, Medal.tv, OBS Studio y Overwolf. Desactiva también los overlays de Discord y GeForce Experience/ShadowPlay y cierra software de mouse/macros en segundo plano.\n2. Abre Seguridad de Windows > Protección contra virus y amenazas > Historial de protección y comprueba si hubo un bloqueo en el mismo horario. Solo restaura o permite un archivo después de confirmar que es oficial y legítimo. Evita exclusiones amplias del antivirus.\n3. Cierra completamente Nébula Launcher y vuelve a abrirlo con Ejecutar como administrador.\n4. Instala/actualiza Microsoft Visual C++ Redistributable (x64) y DirectX End-User Runtime desde fuentes oficiales de Microsoft.\n5. Reinicia el equipo e inténtalo de nuevo. Si continúa, envía a Staff el código 0xC0000005, la hora del error y una captura del Historial de protección sin datos personales."
    }
  },
  "0xC000001D": {
    en: {
      title: "0xC000001D — Illegal Instruction",
      meaning: "Illegal Instruction: the processor attempted to execute an instruction it does not support.",
      cause: "An older or incompatible CPU, commonly without AVX or required SSE instruction support.",
      identification: "Check the exact processor model and generation, then confirm AVX and required SSE support in the manufacturer's official specifications.",
      solution: "1. Identify the exact processor model.\n2. Confirm in the manufacturer's official specifications whether AVX and the required SSE instructions are supported.\n3. Update BIOS and the operating system only if the manufacturer indicates a relevant compatibility fix.\n4. If the CPU does not provide the required instruction, compatible hardware is necessary."
    },
    es: {
      title: "0xC000001D — Illegal Instruction",
      meaning: "Illegal Instruction: el procesador intentó ejecutar una instrucción que no admite.",
      cause: "CPU antigua o incompatible, normalmente sin AVX o sin las instrucciones SSE requeridas.",
      identification: "Comprueba el modelo y la generación exactos del procesador y confirma el soporte de AVX y de las instrucciones SSE requeridas en las especificaciones oficiales del fabricante.",
      solution: "1. Identifica el modelo exacto del procesador.\n2. Confirma en las especificaciones oficiales del fabricante si admite AVX y las instrucciones SSE requeridas.\n3. Actualiza BIOS y el sistema solo si el fabricante indica una corrección de compatibilidad relacionada.\n4. Si la CPU no ofrece la instrucción necesaria, utiliza hardware compatible."
    }
  },
  "0x00000003": {
    en: {
      title: "Fortnite closed during startup / 0x00000003",
      meaning: "Fortnite closes automatically during startup and shows error code 0x00000003.",
      cause: "Windows Smart App Control may be blocking the process or an official launcher component.",
      identification: "The game closes shortly after startup and displays 0x00000003. Also check Windows Security Protection History at the same time, without sharing personal information.",
      solution: "1. Open Windows Security and go to App & browser control.\n2. Open Smart App Control and note whether it is enabled or blocked a file.\n3. Confirm the launcher and reported file came from the official channel and have a valid signature.\n4. Do not disable Windows protection on your own; if an official file was blocked, send a screenshot and file path to Staff for guidance.\n5. Do not treat disabling Smart App Control as a temporary setting: turning it back on may require resetting or reinstalling Windows. Request an officially signed version compatible with the protection.\n6. If the error continues, send Staff the time, blocked file, and startup log for further analysis."
    },
    es: {
      title: "Fortnite se cerró durante el inicio / 0x00000003",
      meaning: "Fortnite se cierra automáticamente durante el inicio y muestra el código 0x00000003.",
      cause: "El Control inteligente de aplicaciones de Windows puede estar bloqueando el proceso o algún componente oficial del launcher.",
      identification: "El juego se cierra poco después de iniciar y muestra 0x00000003. Revisa también el Historial de protección de Seguridad de Windows en el mismo horario, sin compartir datos personales.",
      solution: "1. Abre Seguridad de Windows y entra en Control de aplicaciones y navegador.\n2. Abre Control inteligente de aplicaciones y registra si está activado o bloqueó algún archivo.\n3. Confirma que el launcher y el archivo indicado provienen del canal oficial y tienen una firma válida.\n4. No desactives una protección de Windows por tu cuenta; si se bloqueó un archivo oficial, envía una captura y la ruta a Staff para recibir orientación.\n5. No trates la desactivación del Control inteligente de aplicaciones como un ajuste temporal: volver a activarlo puede requerir restablecer o reinstalar Windows. Solicita una versión oficial firmada compatible con la protección.\n6. Si el código continúa, envía a Staff la hora, el archivo bloqueado y el registro de inicio para un análisis más preciso."
    }
  },
  CONTA_RECEM_CRIADA: {
    en: {
