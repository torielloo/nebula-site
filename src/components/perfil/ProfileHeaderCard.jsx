      ...
      <div className="flex flex-col gap-5 px-5 md:flex-row md:items-end md:gap-7 md:px-7">
        <motion.div variants={item} custom={1} initial="hidden" animate="show" className="relative -mt-16 shrink-0 md:-mt-20">
          <div className="group relative">
            <div className="grid h-24 w-24 place-items-center overflow-hidden rounded-2xl bg-gradient-to-br from-primary/90 to-white/70 text-3xl font-extrabold text-primary-foreground shadow-[0_16px_44px_-14px_rgba(0,0,0,0.95)] ring-4 ring-[#0c0c0c] transition-transform duration-300 group-hover:scale-[1.03] md:h-28 md:w-28">
              {profile.avatar_url ? (
        ...
        <motion.div variants={item} custom={2} initial="hidden" animate="show" className="min-w-0 flex-1 md:pb-2">
          <h1 className="font-heading text-2xl font-extrabold tracking-tight md:text-3xl">{name}</h1>
