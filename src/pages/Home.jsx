      ...
      <section className="relative left-1/2 -mt-14 w-[100vw] -translate-x-1/2 overflow-hidden">
        ...
        {isMobile && heroVideoNeedsTap && (
          <button
            ...
            className="absolute right-4 top-[4.75rem] z-20 flex items-center gap-2 rounded-full border border-white/20 bg-black/70 px-3 py-2 text-xs font-bold text-white shadow-xl backdrop-blur-md sm:hidden"
        ...
        <div className="relative mx-auto flex max-w-[1600px] flex-col items-start px-6 py-28 text-left md:py-44">
          <motion.span
            ...
            className="flex items-center gap-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-1 text-[11px] font-bold text-emerald-400"
          >
          ...
          <motion.span
            ...
            className="mt-5 text-xs font-bold uppercase tracking-[0.35em] text-primary"
          >
            {t("home.hero.kicker")}
          </motion.span>
          <motion.h1
            ...
            className="mt-2 font-display text-4xl font-extrabold leading-[1.05] tracking-tight md:text-7xl"
          ...
          >
            <Link
              ...
              className={cn(
                "flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-bold text-primary-foreground transition-transform hover:-translate-y-0.5",
            ...
            <Link
              ...
              className="flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-6 py-3 text-sm font-bold text-foreground backdrop-blur-xl transition-colors hover:bg-white/15"
            >
