...
export default function OAuthConsent() {
  ...
  const respond = async (action) => {
    ...
    try {
      ...
      // O servidor pode devolver http(s) ou um custom scheme de cliente nativo,
      // mas esquemas executáveis/locais nunca devem ser navegados pelo browser.
      if (!redirectUrl || /[\u0000-\u001f\u007f]/.test(redirectUrl) || /^(?:javascript|data|file|vbscript):/i.test(redirectUrl)) {
