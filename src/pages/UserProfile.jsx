      ...
      <div className="overflow-hidden rounded-3xl border border-border/40 bg-card/50 shadow-[0_28px_90px_-45px_rgba(0,0,0,0.95)]">
        ...
        <div className="relative px-5 pb-6 md:px-8">
          <div className="-mt-14 flex flex-wrap items-end gap-4">
            <ProfileAvatar name={profile.name} avatar={profile.avatar_url} status={profile.status} size="xl" />
            <div className="min-w-0 flex-1 pb-1">
              <div className="flex flex-wrap items-center gap-2">
                <h1 className="truncate font-heading text-2xl font-extrabold md:text-3xl">{profile.name}</h1>
